...
" Highlight files based on type in NERDTree
" Kudos: https://github.com/preservim/nerdtree/issues/433#issuecomment-92590696
...
autocmd VimEnter * if argc() == 0 && !exists("s:std_in") | NERDTree | endif " Open on startup
...
call NERDTreeHighlightFile('tf', 'Red', 'none', 'red', '#151515')
